...
extension UIViewController {
    ...
    private static let DIMMER_VIEW_ID = 999
    
    // Add a dimmer view as the first subview of the currently displayed view
    private func performStartDim(alpha:CGFloat = 0.4, duration:NSTimeInterval = 0.5, sourceView:UIView) {
        ...
        sourceView.addConstraints(NSLayoutConstraint.constraintsWithVisualFormat("|[dimView]|", options: [], metrics: nil, views: ["dimView": dimView]))
        sourceView.addConstraints(NSLayoutConstraint.constraintsWithVisualFormat("V:|[dimView]|", options: [], metrics: nil, views: ["dimView": dimView]))
    ...
    public func startDim(alpha:CGFloat = 0.4, duration:NSTimeInterval = 0.5) {
    ...
    public func stopDim(duration:NSTimeInterval = 0.5) {
